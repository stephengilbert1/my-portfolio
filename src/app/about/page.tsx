  ...
  return (
    <main className="max-w-3xl mx-auto px-6 py-16">
      ...
      <p className="text-slate-700 text-lg mb-4">
        I'm a mechatronics engineer pivoting into software development based in
        Vancouver, BC.
      </p>
      ...
      <p className="text-slate-700 text-lg mb-4">
        ...
        our jobs constantly require us to learn new things.
      </p>
      ...
      <p className="text-slate-700 text-lg">
        ...
        you'll find tools and products that could be applied in the electrical
        utility industry, where I currently work, as well as tech tools for the
        recreational activities I love such as skiing and mountain biking.
      </p>
    </main>
  );
}
